...
分享时请保留本协议，并署名 [@CyC2018](https://dwz.cn/ZGWCOICD)。
...
方便大家系统地整理资料，并且针对每个知识点可以在本脑图中写 Markdown 笔记，每个知识点也有相应的完成度和优先级。
...
- [大数据](https://soulmachine.gitbooks.io/system-design/content/cn/bigdata/)
